  ...
  return (
    <section id="contact" className="py-20 md:py-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-blue-600 to-cyan-500 rounded-2xl p-8 md:p-16 text-center text-white">
          ...
          <p className="text-xl text-blue-100 mb-8 text-balance max-w-2xl mx-auto leading-relaxed">
            Let's discuss how Hornlink Technology can help you automate processes, leverage AI, and scale your
            operations.
          </p>
